...
CREATE TABLE users (
    ...
    account_type ENUM('player', 'developer') NOT NULL DEFAULT 'player',
...
CREATE TABLE games (
    ...
    release_date DATE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_game_dev FOREIGN KEY (developer_id) REFERENCES users(id) ON DELETE CASCADE
);